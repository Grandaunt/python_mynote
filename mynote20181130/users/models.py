...
class User(AbstractUser):
    ...
    sex = models.CharField(max_length=3, default='女')  # 性别
    birthday = models.CharField(max_length=20, default='1996-01-01')  # 8位数字年龄用生日计算
    ...
    zhengzhi_time = models.CharField(max_length=20, default='2010-10-31')  # 6位数字，入党时间，入团时间
    ...
    id_number = models.CharField(max_length=30, default='11010819990121682')  # 身份证号

    xue_li = models.CharField(max_length=30, default='本科')  # 学历
    school = models.CharField(max_length=30, default='河北燕山大学')  # 学校
    ...
    team_belong = models.CharField(max_length=20, default='C001')  # 所属部门

    phone = models.CharField(max_length=30, default='18211083025')  # 手机号
